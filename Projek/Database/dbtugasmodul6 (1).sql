...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2023 at 03:20 PM
...
CREATE TABLE `jobprovider` (
  ...
  `company_contact_num` int(16) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `apply`
  ...
  ADD CONSTRAINT `apply_ibfk_2` FOREIGN KEY (`id_apply`) REFERENCES `jobprovider` (`jp_id`);

--
-- Constraints for table `approve`
--
ALTER TABLE `approve`
  ADD CONSTRAINT `approve_ibfk_1` FOREIGN KEY (`id_approve`) REFERENCES `admin` (`admin_id`);
